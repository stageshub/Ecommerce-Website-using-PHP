...
<head>
    ...
    <!-- Site Metas -->
    <title>About Fresh Phones</title>
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/brooks.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Brooks Morgan</h3> <span class="post">Supervisor</span> </div>
                            <ul class="social">
                                <li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/brooks.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Brooks Morgan</h3> <span class="post">Web Developer</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/brooks.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Brooks Morgan</h3> <span class="post">Designer</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
