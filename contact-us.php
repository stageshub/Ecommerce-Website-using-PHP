...
<head>
    ...
    <!-- Site Metas -->
    <title>Fresh Phones Contact Us</title>
...
<body>
  ...
  <a class="navbar-brand" href="index2.php"><img src="images1/brimages2.jpg" style="height:60px; color:green; font-size:35px;" class="logo" alt=""> FRESH PHONES SHOP</a></b>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="contactForm" method="post" action="email form.php">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                        <input type="submit" class="btn hvr-hover" value="Send Message">
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left" style="background-image:url(./images/TeamLOGO.jpg);" >
                        <h2>CONTACT INFO</h2>
    ...
    <div class="instagram-box" style="background-image:url(./images/back.jpg);">
        <div class="main-instagram owl-carousel owl-theme" style="background-image:url(./images/back.jpg);">
            <div class="item">
