        ...
        <div class="row">
         ...
         <table class="table">
                    ...
                    <tr>
                      ...
                      <td style="font-size:13px;">  <a href="../../view.php?bookisbn=<?php echo $row['product_id']; ?>"><?php echo $row['product_descr']; ?></a></td>
                    
                      <td> 
                        <a href="#?bookisbn=<?php echo $row['product_id']; ?>"><img class="card-img-top" style ="height:40px; width:40px;" src="../../img/<?php echo $row['product_image1']; ?>"></a>
                    </td>
                      <td style="font-size:13px;"><?php echo $row['deleivey_fee']; ?></td>
                    
                      <td  class="text-right" style="font-size:15px"><a href="admin_edit.php?bookisbn=<?php echo $row['product_id']; ?>"class="btn btn-link nc-icon nc-bullet-list-67" name ="edit"></a></td>
                      <td  class="text-right" style="font-size:15px"><a href="admin_delete.php?bookisbn=<?php echo $row['product_id']; ?> "class="btn btn-link nc-icon nc-basket"></a> </a></td>
