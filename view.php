...
<head>
    ...
    <!-- Site Metas -->
    <title>Fresh Phones View Product</title>
                            ...
                            <tbody>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
                                        <img style="height:150px; width:150px;"  src="./img/<?php echo $row['product_image1']; ?>">
                                        <img style="height:150px; width:150px;"  src="./img/<?php echo $row['product_image']; ?>">
								        </a>
                                    </td>
                                    <center>
                                    <td class="name-pr">
                                        <a href="#">
                                        <b><h4 class="card-title"><?php echo $row['product_name']; ?></h4></b>
								</a>
                                    </td>
                                </center>

                                    <td class="price-pr">
                                       <b> <p> <h4> <?php echo "₵" .  $row['product_price']; ?></h4></p></b>
                                    </td>

                                   <b> <td class="quantity-box" style="color: red;">In Stock</td></b>
            ...
            ?>
                ...
                <div class="col-md-6 col-lg-10 col-xl-10">
                    <div class="blog-box">
                            ...
                            <div class="blog-img">
                             <img  src="./img/<?php echo $row['product_image1']; ?>">
                        ...
                        <b> <input type="submit" value="Add to Cart"  name="cart" style="font-size: 24px;" class="btn hvr-hover"> </b>     
