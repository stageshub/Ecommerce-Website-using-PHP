  ...
  <a class="navbar-brand" href="index.php"><img src="images1/brimages2.jpg" style="height:60px; color:green; font-size:35px;" class="logo" alt=""> FRESH PHONES SHOP</a></b>
                ...
                <div class="attr-nav">
                    <ul>
                        ...
                        <li class="nav-item"><a class="nav-link fa fa-log-in" href="signup.php" >| Register |</a></li>
                    </ul>
         ...
         <div class="col-lg-3 col-md-6 special-grid best-seller">
                    ...
                    <div class="products-single fix">
                        ...
                        <div class="box-img-hover">
                            ...
                            <a href="#?bookisbn=<?php echo $items['product_id']; ?>"><img class="card-img-top" src="./img/<?php echo $items['product_image1']; ?>" style="height:200px;width:200px;" alt=""></a>
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="login.php?bookisbn=<?php echo $items['product_id']; ?>" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                   
                                </ul>
                                <a class="cart" href="login.php?bookisbn=<?php echo $items['product_id']; ?>">Add to Cart</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h4><?php echo $items['product_name']; ?></h4>
                            <h5><?php echo "₵" . $items['product_price']; ?></h5>
                        </div>
                    </div>
                </div>
                <?php }?>
        ...
        <div class="footer-main">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact" id="contact">
                            <h4>Contact Us</h4>
                            <ul>
                                <li>
